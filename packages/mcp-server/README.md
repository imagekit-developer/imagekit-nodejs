...
export IMAGEKIT_PRIVATE_API_KEY="My Private API Key"
export ORG_MY_PASSWORD_TOKEN="My Password"
node ./packages/mcp-server/dist/index.js
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npx -y @imagekit/nodejs-mcp`
...
| ---------------------------- | ------------------------ | --------------- |
| `x-imagekit-private-api-key` | `privateAPIKey` | basicAuth |
| `x-org-my-password-token` | `password` | basicAuth |
