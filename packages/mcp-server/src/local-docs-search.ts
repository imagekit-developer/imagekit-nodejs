...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }',
    markdown:
      "## create\n\n`client.namedTransformations.create(name: string, transformation: string, enabled?: boolean): { id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }`\n\n**post** `/v1/named-transformations`\n\nCreates a new named transformation and returns the created object.\n\nNamed transformations let you assign a short, reusable name to a complex transformation string, so it can be applied in image and video URLs as `tr:n-<name>` and later updated without changing any existing URLs.\n\nLearn more about [named transformations](https://imagekit.io/docs/transformations#named-transformations).\n\n**Note:** You can create up to 250 named transformations per account. Once this limit is reached, the request fails with a `400` error.\n\n\n### Parameters\n\n- `name: string`\n  Name of the named transformation. This is the alias used to refer to the transformation string in image and video URLs, for example `tr:n-<name>`. Can only contain alphanumeric characters or `_` (hyphens are not allowed), and must be unique for your account. Name matching is case-sensitive, so `Small_Thumbnail` and `small_thumbnail` are treated as different names.\n\n\n- `transformation: string`\n  The transformation this name refers to, expressed as one or more comma-separated transformation parameters, for example `w-150,h-150,fo-center,cm-resize`. You do not need to prefix this with `tr:` — it is added automatically. If you do include it, it must appear in lowercase at the start of the string, or the request is rejected. Learn more about the [transformation syntax](https://imagekit.io/docs/transformations).\n\n\n- `enabled?: boolean`\n  Whether this named transformation is enabled. Set to `false` to temporarily disable it without deleting it — requests using a disabled named transformation fail at delivery time.\n\n\n### Returns\n\n- `{ id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }`\n  A named transformation is an alias for an actual transformation string, allowing you to apply and later update complex transformations without changing your image or video URLs. Learn more about [named transformations](https://imagekit.io/docs/transformations#named-transformations).\n\n\n  - `id?: string`\n  - `createdAt?: string`\n  - `enabled?: boolean`\n  - `name?: string`\n  - `transformation?: string`\n\n### Example\n\n```typescript\nimport ImageKit from '@imagekit/nodejs';\n\nconst client = new ImageKit();\n\nconst namedTransformation = await client.namedTransformations.create({ name: 'small_thumbnail', transformation: 'w-150,h-150,fo-center,cm-resize' });\n\nconsole.log(namedTransformation);\n```",
    perLanguage: {
      go: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'named_transformations.get',
        example:
          'require "imagekitio"\n\nimage_kit = Imagekitio::Client.new(private_key: "My Private Key", password: "My Password")\n\nnamed_transformation = image_kit.named_transformations.get("id")\n\nputs(named_transformation)',
      },
      typescript: {
        method: 'client.namedTransformations.get',
        example:
      ...
      php: {
        method: 'namedTransformations->get',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(privateKey: 'My Private Key', password: 'My Password');\n\n$namedTransformation = $client->namedTransformations->get('id');\n\nvar_dump($namedTransformation);",
      },
      csharp: {
        method: 'NamedTransformations.Get',
        example:
  ...
  },
  {
    ...
    response:
      '{ id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }',
    markdown:
      "## update\n\n`client.namedTransformations.update(id: string, enabled?: boolean, name?: string, transformation?: string): { id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }`\n\n**patch** `/v1/named-transformations/{id}`\n\nUpdates the named transformation identified by `id` and returns the updated object. Only the fields present in the request body are updated; omitted fields are left unchanged.\n\n**Note:**\n\n- If you rename this named transformation, or set `enabled` to `false`, and another *enabled* named transformation, or your account's upload pre-transformation/post-transformation settings, reference it (via the `n-<name>` token), the request fails with a `409` error whose `message` describes what it is referenced by. A reference from a named transformation that is itself disabled does not block this request. Remove or disable those references first, then retry. This is a best-effort check and cannot detect references baked into your own application code or previously generated URLs.\n\n\n### Parameters\n\n- `id: string`\n\n- `enabled?: boolean`\n  Whether this named transformation is enabled. If omitted, the existing value is left unchanged.\n\n\n- `name?: string`\n  Updated name of the named transformation. Can only contain alphanumeric characters and `_`, and must be unique for your account. Name matching is case-sensitive, so `Small_Thumbnail` and `small_thumbnail` are treated as different names.\n\n\n- `transformation?: string`\n  Updated transformation, expressed as one or more comma-separated transformation parameters. You do not need to prefix this with `tr:` — it is added automatically. If you do include it, it must appear in lowercase at the start of the string, or the request is rejected.\n\n\n### Returns\n\n- `{ id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }`\n  A named transformation is an alias for an actual transformation string, allowing you to apply and later update complex transformations without changing your image or video URLs. Learn more about [named transformations](https://imagekit.io/docs/transformations#named-transformations).\n\n\n  - `id?: string`\n  - `createdAt?: string`\n  - `enabled?: boolean`\n  - `name?: string`\n  - `transformation?: string`\n\n### Example\n\n```typescript\nimport ImageKit from '@imagekit/nodejs';\n\nconst client = new ImageKit();\n\nconst namedTransformation = await client.namedTransformations.update('id');\n\nconsole.log(namedTransformation);\n```",
    perLanguage: {
      go: {
      ...
      ruby: {
        method: 'named_transformations.update',
        example:
          'require "imagekitio"\n\nimage_kit = Imagekitio::Client.new(private_key: "My Private Key", password: "My Password")\n\nnamed_transformation = image_kit.named_transformations.update("id")\n\nputs(named_transformation)',
      },
      typescript: {
        method: 'client.namedTransformations.update',
        example:
  ...
  },
  {
    ...
    response:
      '{ id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }',
    markdown:
      "## delete\n\n`client.namedTransformations.delete(id: string): { id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }`\n\n**delete** `/v1/named-transformations/{id}`\n\nPermanently deletes the named transformation identified by `id` and returns the deleted object.\n\n**Note:**\n\n- If another *enabled* named transformation, or your account's upload pre-transformation/post-transformation settings, reference this named transformation (via the `n-<name>` token), the request fails with a `409` error whose `message` describes what it is referenced by. A reference from a named transformation that is itself disabled does not block this request. Remove or disable those references first, then retry the deletion. This is a best-effort check and cannot detect references baked into your own application code or previously generated URLs.\n\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id?: string; createdAt?: string; enabled?: boolean; name?: string; transformation?: string; }`\n  A named transformation is an alias for an actual transformation string, allowing you to apply and later update complex transformations without changing your image or video URLs. Learn more about [named transformations](https://imagekit.io/docs/transformations#named-transformations).\n\n\n  - `id?: string`\n  - `createdAt?: string`\n  - `enabled?: boolean`\n  - `name?: string`\n  - `transformation?: string`\n\n### Example\n\n```typescript\nimport ImageKit from '@imagekit/nodejs';\n\nconst client = new ImageKit();\n\nconst namedTransformation = await client.namedTransformations.delete('id');\n\nconsole.log(namedTransformation);\n```",
    perLanguage: {
      go: {
        method: 'client.NamedTransformations.Delete',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/imagekit-developer/imagekit-go/v2"\n\t"github.com/imagekit-developer/imagekit-go/v2/option"\n)\n\nfunc main() {\n\tclient := imagekit.NewClient(\n\t\toption.WithPrivateKey("My Private Key"),\n\t\toption.WithPassword("My Password"),\n\t)\n\tnamedTransformation, err := client.NamedTransformations.Delete(context.TODO(), "id")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", namedTransformation.ID)\n}\n',
      },
      java: {
        method: 'namedTransformations().delete',
        example:
          'package io.imagekit.example;\n\nimport io.imagekit.client.ImageKitClient;\nimport io.imagekit.client.okhttp.ImageKitOkHttpClient;\nimport io.imagekit.models.NamedTransformation;\nimport io.imagekit.models.namedtransformations.NamedTransformationDeleteParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        ImageKitClient client = ImageKitOkHttpClient.fromEnv();\n\n        NamedTransformation namedTransformation = client.namedTransformations().delete("id");\n    }\n}',
      },
      python: {
      ...
      ruby: {
        method: 'named_transformations.delete',
        example:
          'require "imagekitio"\n\nimage_kit = Imagekitio::Client.new(private_key: "My Private Key", password: "My Password")\n\nnamed_transformation = image_kit.named_transformations.delete("id")\n\nputs(named_transformation)',
      },
      typescript: {
        method: 'client.namedTransformations.delete',
        example:
      ...
      php: {
        method: 'namedTransformations->delete',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(privateKey: 'My Private Key', password: 'My Password');\n\n$namedTransformation = $client->namedTransformations->delete('id');\n\nvar_dump($namedTransformation);",
      },
      csharp: {
        method: 'NamedTransformations.Delete',
        example:
          'NamedTransformationDeleteParams parameters = new() { ID = "id" };\n\nvar namedTransformation = await client.NamedTransformations.Delete(parameters);\n\nConsole.WriteLine(namedTransformation);',
      },
    },
  },
  {
