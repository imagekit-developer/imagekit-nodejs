...
const fuse = new Fuse(
  [
    ...
    'client.assets.bulk.addTags',
    'client.assets.bulk.delete',
    'client.assets.bulk.removeTags',
    'client.assets.versions.delete',
    'client.assets.versions.get',
    'client.assets.versions.list',
    'client.assets.versions.restore',
    'client.assets.folders.create',
    'client.assets.jobs.get',
