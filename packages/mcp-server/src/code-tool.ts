...
const remoteStainlessHandler = async (
  ...
  IMAGEKIT_PRIVATE_KEY: requireValue(readEnv('IMAGEKIT_PRIVATE_KEY') ?? client.privateKey, 'set IMAGEKIT_PRIVATE_KEY environment variable or provide privateKey client option'),
