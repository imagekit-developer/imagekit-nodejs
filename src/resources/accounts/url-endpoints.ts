...
export class URLEndpoints extends APIResource {
   ...
   * ```
   */
  create(body: URLEndpointCreateParams, options?: RequestOptions): APIPromise<URLEndpointCreateResponse> {
  ...
  ): APIPromise<URLEndpointUpdateResponse> {
   ...
   * @example
   * ```ts
   * const urlEndpoint = await client.accounts.urlEndpoints.get(
   *   'id',
   * );
   * ```
   */
  get(id: string, options?: RequestOptions): APIPromise<URLEndpointGetResponse> {
 ...
 * URL‑endpoint object as returned by the API.
 */
export interface URLEndpointUpdateResponse {
  /**
   * Unique identifier for the URL-endpoint. This is generated by ImageKit when you
   * create a new URL-endpoint. For the default URL-endpoint, this is always
   * `default`.
...
export type URLEndpointListResponse = Array<URLEndpointListResponse.URLEndpointListResponseItem>;

export namespace URLEndpointListResponse {
  /**
   * URL‑endpoint object as returned by the API.
   */
  export interface URLEndpointListResponseItem {
    /**
     * Unique identifier for the URL-endpoint. This is generated by ImageKit when you
     * create a new URL-endpoint. For the default URL-endpoint, this is always
     * `default`.
 ...
 * URL‑endpoint object as returned by the API.
 */
export interface URLEndpointGetResponse {
  /**
   * Unique identifier for the URL-endpoint. This is generated by ImageKit when you
   * create a new URL-endpoint. For the default URL-endpoint, this is always
   * `default`.
...
export interface URLEndpointCreateParams {
   ...
   */
  urlRewriter?:
    | URLEndpointCreateParams.CloudinaryURLRewriter
    | URLEndpointCreateParams.ImgixURLRewriter
    | URLEndpointCreateParams.AkamaiURLRewriter;
}
...
export interface URLEndpointUpdateParams {
   ...
   */
  urlRewriter?:
    | URLEndpointUpdateParams.CloudinaryURLRewriter
    | URLEndpointUpdateParams.ImgixURLRewriter
    | URLEndpointUpdateParams.AkamaiURLRewriter;
}
