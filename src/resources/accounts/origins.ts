...
export class Origins extends APIResource {
  ...
  update(id: string, params: OriginUpdateParams, options?: RequestOptions): APIPromise<OriginUpdateResponse> {
    const { body } = params;
    return this._client.put(path`/v1/accounts/origins/${id}`, { body: body, ...options });
  }
...
export namespace OriginCreateParams {
