...
export type FileUploadParams = FileUploadParams.FileUploadV1 | FileUploadParams.FileUploadV1ByURL;
...
export declare namespace FileUploadParams {
  export interface FileUploadV1 {
     ...
     */
    extensions?: Array<
      FileUploadV1.RemoveBg | FileUploadV1.AutoTaggingExtension | FileUploadV1.AIAutoDescription
    >;
  ...
  export interface FileUploadV1ByURL {
    /**
     ...
     */
    extensions?: Array<
      | FileUploadV1ByURL.RemoveBg
      | FileUploadV1ByURL.AutoTaggingExtension
      | FileUploadV1ByURL.AIAutoDescription
    >;
     ...
     * You can mix and match any combination of post-processing types.
     */
    transformation?: FileUploadV1ByURL.Transformation;
  ...
  export namespace FileUploadV1ByURL {
    export interface RemoveBg {
      /**
       * Specifies the background removal extension.
       */
