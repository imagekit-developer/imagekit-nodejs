...
export type FileUploadParams = FileUploadParams.FileUploadV1 | FileUploadParams.FileUploadByUrlv1;
...
export declare namespace FileUploadParams {
  ...
  export interface FileUploadByUrlv1 {
    /**
     ...
     */
    extensions?: Array<
      | FileUploadByUrlv1.RemoveBg
      | FileUploadByUrlv1.AutoTaggingExtension
      | FileUploadByUrlv1.AIAutoDescription
    >;
  ...
  export namespace FileUploadByUrlv1 {
    export interface RemoveBg {
      /**
       * Specifies the background removal extension.
       */
